  ...
  public static void main(String[] args) {
    ...
    get("/insertItems", (req, res) -> {
      ...
      try {
        ...
        Statement stmt = connection.createStatement();
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS products (price int, name varchar(50), category varchar(50), id int, size float, brandName varchar(50), stock int, img varchar(100), detail varchar(200), love int, PRIMARY KEY (id)");
