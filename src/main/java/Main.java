  ...
  public static void main(String[] args) {
    ...
    get("/insertItems", (req, res) -> {
      ...
      try {
        ...
        stmt.executeUpdate("INSERT INTO items VALUES (000001, 62,  'Luminous Silk Foundation', 'Armarni', 'Foundation', 'This is an award-winning foundation', 'Ivory', 2000, 5, 'Female', 1.0,'images/0001.jpg')");
        stmt.executeUpdate("INSERT INTO items VALUES (000002, 39, 'Rainforest of Seawater Foundation', 'Tarte', 'Foundation', 'A lightweight, full-coverage foundation', 'Ivory', 1000, 10, 'Female', 1.0, 'images/0002.jpg')");
